...
author: "<br>Alberto Rodríguez Rodríguez<br>albrodriguezr@unal.edu.co<br><br>Dirección Nacional de Planeación y Estadística<br>Universidad Nacional de Colombia"
format: 
  revealjs:
    code-fold: true
